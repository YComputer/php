      ...
      <div class="row container-fluid">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="home">All <span class="sr-only">(current)</span></a></li>
            <li><a href="home">Headphones</a></li>
            <li><a href="home">Game Consoles</a></li>
        ...
        <div class="col-sm-9 col-md-10 main">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="home">Game Console</a></li>
  ...
  <script>
    var item = {
      ...
      getDetail:function(){
        ...
        $.ajax({
            type:"post",
            data:{productid:that.getQueryVariable('id')},
